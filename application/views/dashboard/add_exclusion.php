                ...
                <div class="card-body">
                  ...
                  <form action="<?php echo base_url(); ?>Dashboard/save_exclusion" method="post" class="forms-sample">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="number" class="form-control form-control-sm" name="exlusion_num" id="exlusion_num" placeholder="Sort Number">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="exampleInputUsername2" class="col-sm-3 col-form-label text-right">Description</label>
                      <div class="col-sm-9">
                        <textarea class="form-control" name="exclusion_description" id="exclusion_description" rows="4"></textarea>
                      </div>
                    </div>
