                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="<?php echo base_url(); ?>Dashboard/save_tour" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="number" class="form-control form-control-sm" name="tour_start_city" id="tour_start_city" placeholder="Total Number of Days" required>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="exampleInputUsername2" class="col-sm-3 col-form-label text-right">Tour End City</label>
                      <div class="col-sm-9">
                        <input type="number" class="form-control form-control-sm" name="tour_end_city" id="tour_end_city" placeholder="Total Number of Days" required>
                      </div>
                    </div>
                    <div class="form-group row">
