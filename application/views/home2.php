...
<div data-aos="fade-up">
  ...
  <div class="row">
    ...
    <div class="row" style="margin-bottom:30px;">
      <div class="col-md-8" style="padding-left:0px; padding-bottom:0px;">
        <img src="<?php echo base_url(); ?>assets/images/Screenshot_4.jpg" width="100%"    alt="">
      </div>
      <div class="col-md-4" style="padding-right:0px;">
      <img src="<?php echo base_url(); ?>assets/images/Screenshot_5.jpg"  width="100%" alt="">
      </div>
    </div>
    <div class="row" style="margin-bottom:30px;padding-left:0px;">
      <div class="col-md-4" style="padding-left:0px;" >
        <img src="<?php echo base_url(); ?>assets/images/Screenshot_6.jpg" width="100%"  alt="">
      </div>
      <div class="col-md-8" style="padding-right:0px;">
      <img src="<?php echo base_url(); ?>assets/images/Screenshot_7.jpg"  width="100%"  alt="">
      </div>
    </div>
    <div class="row" style="margin-bottom:30px;padding-left:0px;">
